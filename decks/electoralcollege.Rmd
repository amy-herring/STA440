...
- States have electoral college (EC) votes equal to the number of Congressional representatives. 
- Nearly all states use winner-take-all apportionment of EC votes; the state-level popular vote winner receivers all votes.  
- The candidate who wins at least 270 of the 538 votes in the EC wins the election.  
...
![](images/Linzer_Results.png){width=11in}
