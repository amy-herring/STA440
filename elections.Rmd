...
- Weekly updates on predictions starting 10/16: provide point and interval estimates of the probability of the probability that President Trump is re-elected and the probability the US Senate remains in Republican control; please also provide the predicted two-party vote share (point and interval estimates) for the 13 NC Congressional elections and the Tillis vs. Cunningham Senate race.
