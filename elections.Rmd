...
- Weekly updates on predictions starting 10/16: provide point and interval estimates of the probability of the following:
  - probability that President Trump is re-elected
  - probability the US Senate remains in Republican control
  - probability that the Republican candidate wins each of the 13 NC Congressional elections (separately)
  - probability that Senator Tillis keeps his Senate seat
