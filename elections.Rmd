...
# Case Study Goals
Goals of this case study are (1) to predict the probability that the US Senate remains in Republican control, (2) to predict the electoral college vote, and (3) to predict the outcomes of all NC Congressional elections (the 13 federal Representatives to Congress), including characterization of uncertainty in predictions.
