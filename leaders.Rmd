...
- Formal evaluation of Popes paper (Individual assignment due 8/21). Each student will reproduce the analysis in the paper (using either method), update Figure 4 using current data on the two living popes, and provide a peer review of the manuscript. Please use the .Rmd file on Sakai [peek at file format](decks/popes_individual.html) to upload your code and evaluation.
